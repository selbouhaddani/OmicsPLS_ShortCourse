---
title: "Integrating omics underlying Down syndrome with OmicsPLS"
subtitle: "Exercises"
...
:::: {.blueboxx data-latex=""}
<a href="javascript:void()" onclick="toggle_visibility('foo');">
...
```{r Decide on number of components}
set.seed(83654)
...
```{r Decide number of groups, based on covariance}
set.seed(7545)
...
```{r Decide number of groups, based on predicting outcome}
...
```{r Redo CV number of groups around certain values}
